...
from model3 import StyledGenerator, Discriminator
...
def train(args, dataset, generator, discriminator):
    step = int(math.log2(args.init_size)) - 1
    resolution = 2 * 2 ** step
    loader = sample_data(
    ...
    for i in pbar:
        ...
        if used_sample > args.phase * 2:
            ...
            if step > int(math.log2(args.max_size)) - 1:
                step = int(math.log2(args.max_size)) - 1
            ...
            torch.save(
                ...
                f'checkpoint5/train_step-{step}.model',
            )
        ...
        if (i + 1) % 10000 == 0:
            torch.save(
                g_running.state_dict(), f'checkpoint5/{str(i + 1).zfill(6)}.model'
            )
